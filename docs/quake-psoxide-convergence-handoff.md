...
Tracked fixture `editor/archive/fixtures/brush-combat-fixture/` (744K), generated by
...
./target/release/frontend launch \
  ...
  --embedded-playtest \
  --input-tape editor/archive/fixtures/brush-combat-fixture/combat-checkpoint.pxitape.csv \
...
`make run`, open `editor/archive/fixtures/brush-combat-fixture/project.ron`, press
Play: the Level B combat slice live (door, armed enemy, stagger, kill,
traversal). `editor/archive/fixtures/brush-first-playable/project.ron` remains the
...
separate tracked fixture at `editor/archive/fixtures/brush-open-courtyard/`, generated
...
`editor/archive/fixtures/brush-first-playable/project.ron`: native editor use saved a
...
/Users/ebonura/Desktop/repos/PSoXide-convergence/target/release/frontend \
  --windowed \
  --editor \
  --editor-project /Users/ebonura/Desktop/repos/PSoXide-convergence/editor/archive/fixtures/brush-first-playable \
  --editor-view 3d
```
...
camera change in `editor/archive/fixtures/brush-first-playable/project.ron`. Preserve
...
change: `editor/archive/fixtures/brush-first-playable/project.ron`. It records a
...
- `editor/archive/fixtures/souls-bsp-vertical-slice`: a fresh tracked level authored
...
```text
editor/archive/fixtures/brush-first-playable/project.ron
```
...
/tmp/psoxide-bsp-frontend launch \
  ...
  --embedded-playtest \
  --input-tape /Users/ebonura/Desktop/repos/PSoXide-convergence/editor/archive/fixtures/brush-first-playable/walk-through-door.pxitape.csv \
  --guest-frames 220 \
  --steps 2000000000 \
