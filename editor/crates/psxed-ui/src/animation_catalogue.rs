...
pub(crate) struct ModelCatalogueInput {
    ...
    pub(crate) clips: Vec<psxed_project::ModelAnimationClip>,
}
...
pub(crate) fn catalogue_animation_library(
...
pub(crate) fn find_skeleton_by_signature(
...
pub(crate) fn find_animation_clip_by_path(
    project: &ProjectDocument,
    skeleton: ResourceId,
    path: &str,
) -> Option<ResourceId> {
...
pub(crate) fn find_animation_source_by_path(
    project: &ProjectDocument,
...
pub(crate) fn find_animation_set_by_name(
    project: &ProjectDocument,
    skeleton: ResourceId,
    name: &str,
) -> Option<ResourceId> {
...
pub(crate) fn build_animation_set_from_clips(
    project: &ProjectDocument,
    skeleton: ResourceId,
...
pub(crate) fn merge_animation_set(
