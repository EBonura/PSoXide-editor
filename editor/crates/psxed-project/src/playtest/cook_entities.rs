...
pub(crate) fn cook_player_character(
    ...
    characters.push(PlaytestCharacter {
        ...
        stance_aligned_damage_q12: settings.stance_aligned_damage_q12,
        stance_opposed_damage_q12: settings.stance_opposed_damage_q12,
        stance_regen_delay_ticks: settings.stance_regen_delay_ticks,
        stance_broken_regen_delay_ticks: settings.stance_broken_regen_delay_ticks,
        stance_regen_per_tick_q12: settings.stance_regen_per_tick_q12,
        stance_break_threshold_q12: settings.stance_break_threshold_q12,
        stance_swap_cooldown_ticks: settings.stance_swap_cooldown_ticks,
        stance_swap_duration_ticks: settings.stance_swap_duration_ticks,
...
pub(crate) fn character_idle_clip_for_model_instance(
    ...
    if let Some((set_name, set)) = animation_set {
        ...
        if let Some(animation_id) = set.action_clip(CharacterAnimationAction::Idle) {
