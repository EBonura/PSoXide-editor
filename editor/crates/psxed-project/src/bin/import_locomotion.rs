...
//!
//! ```text
//! import-locomotion projects/_legacy-grid/archive/cortex/cortex_anim/project.ron "$HOME/Desktop/Bonnie Studios"
//! ```
//!
...
const PACK: [(&str, CharacterAnimationAction, AnimationRole, bool); 14] = [
    (
        "idle",
