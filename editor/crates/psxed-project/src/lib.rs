...
const SKY_CYCLORAMA_SUN_QUAD_MAX: usize = SKY_CYCLORAMA_SUN_GLOW_QUADS
    + SKY_CYCLORAMA_SUN_BORDER_QUADS
    + SKY_CYCLORAMA_SUN_CORE_QUADS;
    ...
    push_sun_annulus_triangles(
        ...
        |sky, point_yaw, point_pitch, radius_t, theta| {
            ...
            tint = cyclorama_lerp_rgb(
                tint,
                [60, 22, 26],
                (shade * 34.0).clamp(0.0, 255.0) as u8,
            );
            sun_tinted_sky_color(
                sky,
                point_yaw,
