...
The assets are cooked but are not inserted into `project.ron` or painted onto
geometry. That file currently has active unrelated edits; register the cooked
textures in the Editor as new materials before assigning them to BSP faces.
